...
The second optimisation has been to remove the formatting of line 8. In fact, this formatting is only necessary to compute a correct $v$ %TODO what does 'a correct v means?
